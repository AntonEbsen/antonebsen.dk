            ...
            <div className="relative z-10">
                <div className="flex items-baseline justify-center gap-6 mb-6">
                    <div>
                        ...
                        <span className="text-[10px] uppercase tracking-widest text-slate-500">{t.works}</span>
                    </div>
                    <span className="text-slate-700">·</span>
                    <div>
                        <span className="block text-3xl font-bold text-white tabular-nums">{links.length}</span>
                        <span className="text-[10px] uppercase tracking-widest text-slate-500">{t.connections}</span>
                    </div>
                </div>
                ...
                <p className="text-[10px] text-slate-600 mt-5 max-w-xs mx-auto leading-relaxed">{t.note}</p>
            </div>
        </div>
    );
}
